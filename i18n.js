...
const I18N_DICT = {
  en: {
    ...
    nav_learn: "Learn",
    nav_process: "How elections work",
    nav_parliament: "Parliament",
    nav_pms: "Prime Ministers",
    nav_about: "About",
    nav_states: "States",
    ...
    footer_tagline: "An independent, unofficial intelligence platform — histories, results, sentiment and analysis — tracking Malaysia's rolling state election cycle.",
  ...
  ms: {
    ...
    nav_learn: "Ketahui",
    nav_process: "Cara pilihan raya berjalan",
    nav_parliament: "Parlimen",
    nav_pms: "Perdana Menteri",
    nav_about: "Tentang",
    nav_states: "Negeri",
    ...
    footer_tagline: "Platform maklumat bebas dan tidak rasmi — sejarah, keputusan, sentimen dan analisis — yang menjejaki kitaran pilihan raya negeri Malaysia.",
  ...
  zh: {
    ...
    footer_tagline: "一个独立、非官方的信息平台——历史、结果、情绪与分析——追踪马来西亚各州选举周期的最新动态。",
  ...
  ta: {
    ...
    nav_learn: "அறிக",
    nav_process: "தேர்தல் எவ்வாறு நடக்கிறது",
    nav_parliament: "நாடாளுமன்றம்",
    nav_pms: "பிரதமர்கள்",
    ...
    footer_tagline: "மலேசியாவின் தொடர் மாநில தேர்தல் சுழற்சியைக் கண்காணிக்கும் ஒரு சுயாதீன, அதிகாரப்பூர்வமற்ற தகவல் தளம் — வரலாறு, முடிவுகள், உணர்வு மற்றும் பகுப்பாய்வு.",
